...
- [ ] **2.6-8. 디자인 최종 critique** (P2, Claude, **W-1 시점 유지가 권장** — 최종 상태를 봐야 의미) — D-Day 직전 나침반.
  07-12 경량 자체검토는 수행(리팩터링 잔재 0·hostMatch 제거 무결·C-2 10/10·인라인 45스크립트 0실패) — 정식 듀얼 critique만 W-1에.
